...
<html lang="en">
<?php
$metaTitle = "Social Media Marketing - Grow2Design | Comprehensive Digital Marketing Solutions";
$metaDescription = "";
$metaKeywords = "";
$metaOGImage = "";
...
<body class="bg-background">
            ...
            <div class="container-custom relative">
                <div class="max-w-4xl mx-auto text-center space-y-8">
                    <div class="space-y-4" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <h1 class="text-hero" data-aos="fade-right" data-aos-delay="400"><span class="text-gradient">Social Media Marketing</span></h1>
                        <p class="text-xl text-text-secondary leading-relaxed max-w-3xl mx-auto">Build engaged communities and drive conversions through strategic content creation and community management.</p>
                    </div>
    ...
    <section class="section-padding">
        <div class="container-custom">
            ...
            <div id="social-media" class="mb-24">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="relative lg:order-2" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100">
                        <img src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?q=80&w=2939&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Social media marketing and content creation" class="w-full h-96 object-cover rounded-2xl shadow-conversion" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2017/06/26/19/03/social-media-2444884_1280.jpg'; this.onerror=null;" />
                    ...
                    <div class="space-y-8 lg:order-1" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <h3 class="text-2xl font-bold text-text-primary">Social Media Marketing</h3>
                            </div>
                            <p class="text-body">Build engaged communities and drive conversions through strategic content creation, community management, and data-driven social media campaigns across all major platforms.</p>
                        </div>

                        <!-- Process Steps -->
                        <div class="space-y-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                            <h4 class="text-lg font-semibold text-text-primary">Our Approach</h4>
                            <div class="space-y-3">
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Strategy Development</div>
                                        <div class="text-sm text-text-secondary">Platform selection, content pillars, posting schedule</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Content Creation</div>
                                        <div class="text-sm text-text-secondary">Visual content, copywriting, video production</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Community Management</div>
                                        <div class="text-sm text-text-secondary">Engagement, customer service, reputation management</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-white text-sm font-bold">4</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Performance Optimization</div>
                                        <div class="text-sm text-text-secondary">Analytics tracking, A/B testing, strategy refinement</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 p-6 bg-surface rounded-xl" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="400">
                            <div class="text-center">
                                ...
                                <div class="text-sm text-text-secondary">Community Growth</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-success">$2M</div>
                                <div class="text-sm text-text-secondary">Social Commerce Revenue</div>
                            </div>
                        </div>

                        <div class="flex space-x-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                            <a href="<?php echo BASE_URL; ?>pages/contact_us.php" class="btn-primary">Launch Social Strategy</a>
                            <button class="btn-secondary" onclick="toggleFAQ('social-faq')">View FAQ</button>
                        </div>
                    </div>
                </div>

                <!-- FAQ Section -->
                <div id="social-faq" class="hidden mt-12 p-6 bg-surface rounded-xl">
                    <h4 class="text-lg font-semibold text-text-primary mb-6">Frequently Asked Questions - Social Media</h4>
                    <div class="space-y-4">
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">Which platforms do you manage?</div>
                            <div class="text-text-secondary">We manage all major platforms including Facebook, Instagram, Twitter, LinkedIn, TikTok, and YouTube. Platform selection depends on your target audience and business goals.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">How often do you post content?</div>
                            <div class="text-text-secondary">Posting frequency varies by platform and strategy, typically 3-7 posts per week per platform. We focus on quality and engagement over quantity.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">Do you handle customer service on social media?</div>
                            <div class="text-text-secondary">Yes, we provide community management including responding to comments, messages, and reviews within agreed response times, typically 2-4 hours during business hours.</div>
                        </div>
                    </div>
                </div>
            </div>
