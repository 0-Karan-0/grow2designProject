...
<html lang="en">
<?php
$metaTitle = "Search Engine Optimization - Grow2Design | Comprehensive Digital Marketing Solutions";
$metaDescription = "";
$metaKeywords = "";
$metaOGImage = "";
            ...
            <div class="container-custom relative">
                <div class="max-w-4xl mx-auto text-center space-y-8">
                    <div class="space-y-4" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <h1 class="text-hero" data-aos="fade-right" data-aos-delay="400"><span class="text-gradient">Search Engine Optimization</span></h1>
                        <p class="text-xl text-text-secondary leading-relaxed max-w-3xl mx-auto">Increase organic visibility and drive qualified traffic through comprehensive SEO strategies and technical optimization.</p>
                    </div>
                    ...
                    <div class="space-y-8" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <h3 class="text-2xl font-bold text-text-primary">Search Engine Optimization</h3>
                            </div>
                            <p class="text-body">Increase organic visibility and drive qualified traffic through comprehensive SEO strategies, technical optimization, and content marketing that delivers long-term results.</p>
                        </div>

                        <!-- Process Steps -->
                        <div class="space-y-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                            <h4 class="text-lg font-semibold text-text-primary">Our Methodology</h4>
                            <div class="space-y-3">
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-success rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                                    <div>
                                        <div class="font-medium text-text-primary">SEO Audit</div>
                                        <div class="text-sm text-text-secondary">Technical analysis, keyword research, competitor review</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-success rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                                    <div>
                                        <div class="font-medium text-text-primary">On-Page Optimization</div>
                                        <div class="text-sm text-text-secondary">Content optimization, meta tags, internal linking</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-success rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Technical SEO</div>
                                        <div class="text-sm text-text-secondary">Site speed, mobile optimization, schema markup</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-success rounded-full flex items-center justify-center text-white text-sm font-bold">4</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Link Building</div>
                                        <div class="text-sm text-text-secondary">Authority building, outreach, content marketing</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 p-6 bg-surface rounded-xl" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="400">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-success">400%</div>
                                <div class="text-sm text-text-secondary">Organic Traffic Increase</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-primary">Top 3</div>
                                <div class="text-sm text-text-secondary">Average Ranking Position</div>
                            </div>
                        </div>

                        <div class="flex space-x-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                            <a href="<?php echo BASE_URL; ?>pages/contact_us.php" class="btn-primary">Start SEO Campaign</a>
                            <button class="btn-secondary" onclick="toggleFAQ('seo-faq')">View FAQ</button>
                        </div>
                    </div>

                    <div class="relative" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100">
                        <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2426&auto=format&fit=crop&ixlib=rb-4.0.3" alt="SEO optimization and search engine ranking" class="w-full h-96 object-cover rounded-2xl shadow-conversion" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2017/05/10/19/29/seo-2301494_1280.jpg'; this.onerror=null;" />
                        <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-success/20 rounded-full blur-3xl"></div>
                    </div>
                </div>

                <!-- FAQ Section -->
                <div id="seo-faq" class="hidden mt-12 p-6 bg-surface rounded-xl">
                    <h4 class="text-lg font-semibold text-text-primary mb-6">Frequently Asked Questions - SEO</h4>
                    <div class="space-y-4">
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">How long does SEO take to show results?</div>
                            <div class="text-text-secondary">SEO is a long-term strategy. Initial improvements can be seen in 3-6 months, with significant results typically appearing after 6-12 months of consistent optimization.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">Do you guarantee first-page rankings?</div>
                            <div class="text-text-secondary">We don't guarantee specific rankings as search algorithms constantly evolve. However, we guarantee improved visibility, traffic, and search performance through proven strategies.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">What's included in your SEO reporting?</div>
                            <div class="text-text-secondary">Monthly reports include keyword rankings, organic traffic growth, technical improvements, backlink acquisition, and competitive analysis with actionable insights.</div>
                        </div>
                    </div>
                </div>
            </div>
