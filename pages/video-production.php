...
<html lang="en">
<?php
$metaTitle = "Video Production - Grow2Design | Comprehensive Digital Marketing Solutions";
$metaDescription = "";
$metaKeywords = "";
$metaOGImage = "";
...
<body class="bg-background">
            ...
            <div class="container-custom relative">
                <div class="max-w-4xl mx-auto text-center space-y-8">
                    <div class="space-y-4" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <h1 class="text-hero" data-aos="fade-right" data-aos-delay="400"><span class="text-gradient">Video Production</span></h1>
                        <p class="text-xl text-text-secondary leading-relaxed max-w-3xl mx-auto">Create compelling video content that tells your brand story and drives engagement across all digital platforms.</p>
                    </div>
  ...
  <div class="container-custom">
    ...
    <div id="video-production" class="mb-24">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        
        <!-- Image Section -->
        <div class="relative lg:order-2" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100" >
          <img src="https://images.unsplash.com/photo-1492619375914-88005aa9e8fb?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Video production and content creation" class="w-full h-96 object-cover rounded-2xl shadow-conversion" loading="lazy" onerror="this.src='https://images.pexels.com/photos/66134/pexels-photo-66134.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; this.onerror=null;" />
          <div class="absolute -bottom-6 -left-6 w-32 h-32 bg-warning/20 rounded-full blur-3xl"></div>
        </div>

        <!-- Text & Content Section -->
        <div class="space-y-8 lg:order-1" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <h3 class="text-2xl font-bold text-text-primary">Video Production</h3>
            </div>
            <p class="text-body">
              Create compelling video content that tells your brand story and drives engagement across all digital platforms with professional production and strategic storytelling.
            </p>
          </div>

          <!-- Process Steps -->
          <div class="space-y-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
            <h4 class="text-lg font-semibold text-text-primary">Production Process</h4>
            <div class="space-y-3">
              <div class="flex items-start space-x-3">
                <div class="w-6 h-6 bg-warning rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                <div>
                  <div class="font-medium text-text-primary">Concept Development</div>
                  <div class="text-sm text-text-secondary">Creative brief, storyboarding, script writing</div>
                </div>
              </div>
              <div class="flex items-start space-x-3">
                <div class="w-6 h-6 bg-warning rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                <div>
                  <div class="font-medium text-text-primary">Pre-Production</div>
                  <div class="text-sm text-text-secondary">Location scouting, casting, equipment planning</div>
                </div>
              </div>
              <div class="flex items-start space-x-3">
                <div class="w-6 h-6 bg-warning rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                <div>
                  <div class="font-medium text-text-primary">Production</div>
                  <div class="text-sm text-text-secondary">Filming, directing, professional equipment and crew</div>
                </div>
              </div>
              <div class="flex items-start space-x-3">
                <div class="w-6 h-6 bg-warning rounded-full flex items-center justify-center text-white text-sm font-bold">4</div>
                <div>
                  <div class="font-medium text-text-primary">Post-Production</div>
                  <div class="text-sm text-text-secondary">Editing, color grading, sound design, final delivery</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Success Metrics -->
          <div 
            class="grid grid-cols-2 gap-6 p-6 bg-surface rounded-xl" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="400">
            <div class="text-center">
              <div class="text-2xl font-bold text-warning">85%</div>
              <div class="text-sm text-text-secondary">Engagement Increase</div>
            </div>
            <div class="text-center">
              <div class="text-2xl font-bold text-success">200%</div>
              <div class="text-sm text-text-secondary">Conversion Boost</div>
            </div>
          </div>

          <div 
            class="flex space-x-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
            <a href="<?php echo BASE_URL; ?>pages/contact_us.php" class="btn-primary">Start Video Project</a>
            <button class="btn-secondary" onclick="toggleFAQ('video-faq')">View FAQ</button>
          </div>
        </div>
      </div>

      <!-- FAQ Section -->
      <div id="video-faq" class="hidden mt-12 p-6 bg-surface rounded-xl">
        <h4 class="text-lg font-semibold text-text-primary mb-6">Frequently Asked Questions - Video Production</h4>
        <div class="space-y-4">
          <div class="border-b border-secondary-200 pb-4">
            <div class="font-medium text-text-primary mb-2">What types of videos do you produce?</div>
            <div class="text-text-secondary">We create promotional videos, explainer videos, testimonials, product demos, social media content, corporate videos, and animated content tailored to your brand and objectives.</div>
          </div>
          <div class="border-b border-secondary-200 pb-4">
            <div class="font-medium text-text-primary mb-2">How long does video production take?</div>
            <div class="text-text-secondary">Timeline varies by complexity. Simple videos take 2-3 weeks, while complex productions can take 4-6 weeks. We provide detailed timelines during the planning phase.</div>
          </div>
          <div class="border-b border-secondary-200 pb-4">
            <div class="font-medium text-text-primary mb-2">Do you provide video optimization for different platforms?</div>
            <div class="text-text-secondary">Yes, we optimize videos for specific platforms including YouTube, Instagram, Facebook, LinkedIn, and websites with appropriate formats, dimensions, and compression settings.</div>
          </div>
        </div>
      </div>
