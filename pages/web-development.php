...
<html lang="en">
<?php
$metaTitle = "Web Development - Grow2Design | Comprehensive Digital Marketing Solutions";
$metaDescription = "";
$metaKeywords = "";
$metaOGImage = "";
...
<body class="bg-background">
            ...
            <div class="container-custom relative">
                <div class="max-w-4xl mx-auto text-center space-y-8">
                    <div class="space-y-4" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <h1 class="text-hero" data-aos="fade-right" data-aos-delay="400"><span class="text-gradient">Web Development</span></h1>
                        <p class="text-xl text-text-secondary leading-relaxed max-w-3xl mx-auto">Build high-performance, conversion-optimized websites that provide exceptional user experiences across all devices.</p>
                    </div>
    ...
    <section class="section-padding">
        <div class="container-custom">
            ...
            <div id="web-development" class="mb-24">
                    ...
                    <div class="space-y-8" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <h3 class="text-2xl font-bold text-text-primary">Web Development</h3>
                            </div>
                            <p class="text-body">Build high-performance, conversion-optimized websites that provide exceptional user experiences across all devices with modern technologies and best practices.</p>
                        </div>

                        <!-- Process Steps -->
                        <div class="space-y-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                            <h4 class="text-lg font-semibold text-text-primary">Development Process</h4>
                            <div class="space-y-3">
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-secondary-600 rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Planning & Architecture</div>
                                        <div class="text-sm text-text-secondary">Requirements analysis, wireframing, technical specifications</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-secondary-600 rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Design & Prototyping</div>
                                        <div class="text-sm text-text-secondary">UI/UX design, responsive layouts, interactive prototypes</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-secondary-600 rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Development & Testing</div>
                                        <div class="text-sm text-text-secondary">Frontend/backend coding, quality assurance, performance optimization</div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div class="w-6 h-6 bg-secondary-600 rounded-full flex items-center justify-center text-white text-sm font-bold">4</div>
                                    <div>
                                        <div class="font-medium text-text-primary">Launch & Support</div>
                                        <div class="text-sm text-text-secondary">Deployment, training, ongoing maintenance and updates</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 p-6 bg-surface rounded-xl" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="400">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-secondary-600">2.5s</div>
                                <div class="text-sm text-text-secondary">Average Load Time</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-success">95%</div>
                                <div class="text-sm text-text-secondary">Performance Score</div>
                            </div>
                        </div>

                        <div class="flex space-x-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                            <a href="<?php echo BASE_URL; ?>pages/contact_us.php" class="btn-primary">Start Web Project</a>
                            <button class="btn-secondary" onclick="toggleFAQ('web-faq')">View FAQ</button>
                        </div>
                    </div>

                    <div class="relative" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Web development and responsive design" class="w-full h-96 object-cover rounded-2xl shadow-conversion" loading="lazy" onerror="this.src='https://images.pixabay.com/photo/2016/11/19/14/00/code-1839406_1280.jpg'; this.onerror=null;" />
                        <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-secondary-400/20 rounded-full blur-3xl"></div>
                    </div>
                </div>

                <!-- FAQ Section -->
                <div id="web-faq" class="hidden mt-12 p-6 bg-surface rounded-xl">
                    <h4 class="text-lg font-semibold text-text-primary mb-6">Frequently Asked Questions - Web Development</h4>
                    <div class="space-y-4">
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">What technologies do you use?</div>
                            <div class="text-text-secondary">We use modern technologies including React, Next.js, Node.js, Python, and cloud platforms like AWS. Technology selection depends on project requirements and scalability needs.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">Do you provide ongoing maintenance?</div>
                            <div class="text-text-secondary">Yes, we offer comprehensive maintenance packages including security updates, performance monitoring, content updates, and technical support with various service levels.</div>
                        </div>
                        <div class="border-b border-secondary-200 pb-4">
                            <div class="font-medium text-text-primary mb-2">Is the website mobile-responsive?</div>
                            <div class="text-text-secondary">Absolutely. All our websites are built with mobile-first responsive design, ensuring optimal performance and user experience across all devices and screen sizes.</div>
                        </div>
                    </div>
                </div>
            </div>
